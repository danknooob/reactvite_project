...
function Navbar() {
  ...
  return (
    <div className={`fixed z-[999] w-full px-20 py-8 flex justify-between items-center transition-transform duration-300 ${visible ? 'transform translate-y-0' : 'transform -translate-y-full'}`}>
      <div className="logo">
      <Link to="/" className="text-lg capitalize font-light">
      ...
      <div className="links flex gap-12">
        <Link to="/Services" className="text-lg capitalize font-light">Services</Link>
        <Link to="/OurWork" className="text-lg capitalize font-light">Our Work</Link>
        <Link to="/AboutUs" className="text-lg capitalize font-light">About Us</Link>
        <Link to="/Insights" className="text-lg capitalize font-light">Insights</Link>
