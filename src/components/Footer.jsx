...
import clsx from 'clsx'; // Import clsx package
    ...
    <div className='flex gap-5 w-full h-screen bg-zinc-900 p-20'>
      <div className='w-1/2 h-full flex flex-col justify-between '>
        <div className="headings">
          <h1 className='text-[5vw] leading-none font-bold -mb-15'>EYE-</h1>
          <h1 className='text-[5vw] leading-none font-bold -mb-15'>OPENING</h1>
        </div>
      ...
      <div className='w-1/2'>
        <h1 className='text-[5vw] leading-none font-bold -mb-15 uppercase'>Comparisons</h1>
        <div className="dets mt-20">
          {links.map((link) => (
            <a
              key={link.id}
              href={link.url}
              className={clsx('block social-list__link link', {
                'link--underline': true, 
              })}
            >
              {link.text}
